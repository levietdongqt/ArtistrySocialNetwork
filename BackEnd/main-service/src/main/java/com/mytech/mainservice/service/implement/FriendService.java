...
public class FriendService implements IFriendService {
    ...
    public void addFriend(String userId, String friendId) {
        ...
        Friendship savedFriendShip = friendshipRepo.save(newFriendship);
        //Send notification
        sendNotificationAfterAddFriendship(userId, friendId, "FRIEND", "đã gửi lời mời kết bạn");
    }
    ...
    public boolean acceptFriendRequest(String userId, String friendId) {
        ...
        if (friendship.isPresent()) {
            ...
            friendship.get().setStatus(status);
            Friendship savedFriendShip = friendshipRepo.save(friendship.get());
            createConversation(savedFriendShip.getFriend(), savedFriendShip.getFromUser());
