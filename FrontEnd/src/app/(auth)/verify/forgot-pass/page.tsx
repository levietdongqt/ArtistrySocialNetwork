...
export default function ForgotPass() {
    ...
    useEffect(() => {
        if (!window.confirmationResult) {
            Swal.fire({
                ...
                footer: 'Bạn đã muốn lấy lại mật khẩu? Thao tác  <div><a href="/verify/re-verify?forgot-pass=true" class="text-blue-700 underline">  tại đây! </a></div>'
    ...
    const {values, touched, handleSubmit, handleChange, errors, isValid, resetForm} = useFormik({
        ...
        onSubmit: values => {
            ...
            showConfirmation({password: values.password, phoneNumber: phoneNumber})
        },
