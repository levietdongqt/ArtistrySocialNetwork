...
export function Invoice({order,callback}: props) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-lg px-8 py-10 max-w-xl mx-auto">
            <h2 className="text-2xl text-center font-bold mb-4">Xác nhận thông tin</h2>
            <div className="border-b-2 border-gray-300 pb-2 mb-2">
                ...
                <div className="text-gray-700 mb-2">0{currentUser!.phoneNumber?.substring(3)}</div>
                <div className="text-gray-700">{order.customerUser.email}</div>
            </div>
