...
export default function Promotions() {
  ...
  const {
    ...
    isLoading: isLoading,
    error: error2,
  } = useSWR(getAllPromotions(currentUser?.id as string), fetcherWithToken);
  ...
  return (
    <div>
      ...
      <PromotionsTable data={!changeStatus ? mainDataTrue as any : mainDataFalse as any}></PromotionsTable>
    </div>
  );
}
